...
let h3header = document.querySelectorAll('h3');
...
h3header[0].style.fontSize = '15px';
h3header[0].style.textDecoration = 'underline';
h3header[0].style.fontWeight = '380';

h3header[1].style.fontSize = '15px';
h3header[1].style.fontWeight = '360';
